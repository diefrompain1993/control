...
export function Contractors() {
  ...
  const vehicles = useMemo(() => {
    return mergeVehicles(BASE_VEHICLES.contractor, getStoredVehiclesByCategory('contractor'));
  }, [refreshKey]);
  ...
  const handleSave = () => {
    ...
    if (editingVehicle) {
      ...
      const detailsParts: string[] = ['Список: Подрядчики'];
      ...
      addAuditLogEntry({
        ...
        target: normalizedPlate,
        details: `Список: Подрядчики · Владелец: ${trimmedOwner}`
      });
    }
  ...
  const handleDelete = (vehicle: StoredVehicle) => {
    ...
    addAuditLogEntry({
      ...
      details: `Список: Подрядчики · Владелец: ${vehicle.owner}`
    });
              ...
              <DialogContent className="max-w-xl">
                <DialogHeader>
                  ...
                  <DialogDescription className="text-foreground font-medium">
                    {editingVehicle
                      ? 'Обновите данные подрядчика и автомобиля.'
                      : 'Укажите данные подрядчика и автомобиля.'}
                  </DialogDescription>
                </DialogHeader>
                  ...
                  <div className="grid gap-4">
                    ...
                    <div>
                      <Input
                        ...
                        placeholder="Например, срок доступа"
                      />
                    </div>
                  </div>
            ...
            <tbody className="bg-white">
              {isLoading ? (
                ...
                sortedData.map((vehicle) => (
                  ...
                  >
                    <td className="py-4 px-6 text-[14px] font-semibold text-purple-600 font-mono">
