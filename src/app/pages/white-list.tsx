...
export function WhiteList() {
  ...
  const vehicles = useMemo(() => {
    return mergeVehicles(BASE_VEHICLES.white, getStoredVehiclesByCategory('white'));
  }, [refreshKey]);
  ...
  const handleSave = () => {
    ...
    if (editingVehicle) {
      ...
      const detailsParts: string[] = ['Список: Белый'];
      ...
      addAuditLogEntry({
        ...
        target: normalizedPlate,
        details: `Список: Белый · Владелец: ${trimmedOwner}`
      });
    }
  ...
  const handleDelete = (vehicle: StoredVehicle) => {
    ...
    addAuditLogEntry({
      ...
      details: `Список: Белый · Владелец: ${vehicle.owner}`
    });
                ...
                <DialogHeader>
                  ...
                  <DialogDescription className="text-foreground font-medium">
                    {editingVehicle
                      ...
                      : 'Укажите данные владельца и автомобиля для белого списка.'}
                  </DialogDescription>
                </DialogHeader>
            ...
            <tbody className="bg-white">
              {isLoading ? (
                ...
                sortedData.map((vehicle) => (
                  ...
                  >
                    <td className="py-4 px-6 text-[14px] font-semibold text-emerald-600 font-mono">
